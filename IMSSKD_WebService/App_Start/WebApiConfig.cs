...
namespace IMSSKD_WebService
{
    public abstract class WebApiConfig
    {
        ...
        private static void OnDisconnect(int iSessionID)
        {
            try
            {
        ...
        //{
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnGetSabreIdForUserResponded += new _IIMSClientEvents_OnGetSabreIdForUserRespondedEventHandler(OnGetSabreIdResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnBackPressure += new _IIMSClientEvents_OnBackPressureEventHandler(OnBackPressureEvent);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnGetAcceleratorVersionResponded += new _IIMSClientEvents_OnGetAcceleratorVersionRespondedEventHandler(OnGetAcceleratorVersionResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnAddSingleEyeResponded += new _IIMSClientEvents_OnAddSingleEyeRespondedEventHandler(OnAddSingleEyeResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnAddBothEyesResponded += new _IIMSClientEvents_OnAddBothEyesRespondedEventHandler(OnAddBothEyesResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnMatchSingleEyeResponded += new _IIMSClientEvents_OnMatchSingleEyeRespondedEventHandler(OnMatchSingleEyeResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnMatchBothEyesResponded += new _IIMSClientEvents_OnMatchBothEyesRespondedEventHandler(OnMatchBothEyesResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnRemoveUserResponded += new _IIMSClientEvents_OnRemoveUserRespondedEventHandler(OnRemoveUserResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnAddSingleEyeForcedResponded += new _IIMSClientEvents_OnAddSingleEyeForcedRespondedEventHandler(OnAddSEForcedResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnAddBothEyeForcedResponded += new _IIMSClientEvents_OnAddBothEyeForcedRespondedEventHandler(OnAddBEForcedResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnDisconnect += new _IIMSClientEvents_OnDisconnectEventHandler(OnDisconnect);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnError += new _IIMSClientEvents_OnErrorEventHandler(OnError);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnDeleteAllIrisCodesResponded += new _IIMSClientEvents_OnDeleteAllIrisCodesRespondedEventHandler(OnDeleteAllIrisCode);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnAlarm += new _IIMSClientEvents_OnAlarmEventHandler(OnAlarmRaised);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnUpdateEyesResponded += new _IIMSClientEvents_OnUpdateEyesRespondedEventHandler(OnUpdateEyesResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnGetUserTemplatesResponded += new _IIMSClientEvents_OnGetUserTemplatesRespondedEventHandler(OnGetUserTemplatesResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnVerifySingleEyeResponded += new _IIMSClientEvents_OnVerifySingleEyeRespondedEventHandler(OnVerifySingleEyeResponded);
        //    IMSSKD_WebService.WebApiApplication.m_ImsClient.OnVerifyBothEyesResponded += new _IIMSClientEvents_OnVerifyBothEyesRespondedEventHandler(OnVerifyBothEyesResponded);
        //}
